...
## Questions? Comments?
If you have any questions, feedback, or suggestions, please feel free to reach out to me via email at mr.ylraihan@gmail.com. You can also open an issue on the project's repository on GitHub here. I had a lot of fun creating this project, writing about React Context, and explaining it to new developers
...
- I don't have any rhyme or reason why I set the initial value to `kangaroos`. 
# Context
